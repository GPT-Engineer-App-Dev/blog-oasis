            ...
            <VStack spacing={8} align="stretch">
              <Box p={5} shadow="md" borderWidth="1px">
                ...
                <VStack align="start" mt={4}>
                  <Link href="#" _hover={{ textDecoration: "none", color: "gray.600" }}>Post 1</Link>
                  <Link href="#" _hover={{ textDecoration: "none", color: "gray.600" }}>Post 2</Link>
                  <Link href="#" _hover={{ textDecoration: "none", color: "gray.600" }}>Post 3</Link>
                </VStack>
              </Box>
              <Box p={5} shadow="md" borderWidth="1px">
